...
var (
	...
	spinnerStyle = lipgloss.NewStyle().Foreground(lipgloss.Color("34"))         // 34 - Dark Cyan/Green

	loadSpinner       = spinner.Pulse
	generatingSpinner = spinner.Points
)
...
func (m model) startSpinner(s spinner.Spinner) {
